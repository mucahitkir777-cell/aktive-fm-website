        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-14">
            ...
            <div className="lg:col-span-1 pc-fade-up">
              <h2 className="text-xl font-bold pc-text-primary mb-6" style={{ fontFamily: "Inter, sans-serif" }}>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <div className="font-semibold pc-text-primary text-sm mb-1" style={{ fontFamily: "Inter, sans-serif" }}>
                      Telefon
                    </div>
